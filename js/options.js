(function () {
    ideaPress.options = {
        ...
        modules: [
            ...
            , { name: wordpresscomModule, options: { id: 2, apiUrl: 'cbsnewyork.wordpress.com', title: 'bookmark', typeId: wordpresscomModule.BOOKMARKS } }
            ...
            , { name: wordpresscomModule, options: { id: 4, siteDomain: 'cbsnewyork.wordpress.com', title: "Sports", typeId: wordpresscomModule.CATEGORY, categoryId: "Sports", showHub: true, hubSize: 2, templateName: "wpc-tpl-0" } }
            , { name: wordpresscomModule, options: { id: 5, siteDomain: 'cbsnewyork.wordpress.com', title: "Best Of", typeId: wordpresscomModule.CATEGORY, categoryId: "Best Of", showHub: true, hubSize: 2, templateName: "wpc-tpl-0" } }
            , { name: wordpresscomModule, options: { id: 6, siteDomain: 'cbsnewyork.wordpress.com', title: "Travel", typeId: wordpresscomModule.CATEGORY, categoryId: "Travel", showHub: true, hubSize: 2, templateName: "wpc-tpl-0" } }
        ],
