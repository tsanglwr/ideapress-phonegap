(function () {
    ideaPress.options = {
        ...
        modules: [
            ...
            , { name: wordpresscomModule, options: { id: 2, siteDomain: 'cbsnewyork.wordpress.com', title: 'bookmark', typeId: wordpresscomModule.BOOKMARKS, showHub: true, hubSize: 1, templateName: "wpc-tpl-0" } }
