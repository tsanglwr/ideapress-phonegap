(function () {
    ideaPress.options = {
        ...
        modules: [
            ...
            , { name: wordpresscomModule, options: { id: 2, siteDomain: 'cbsnewyork.wordpress.com', title: "News", typeId: wordpresscomModule.CATEGORY, categoryId: "News", showHub: true, hubSize: 2, templateName: "wpc-tpl-0" } }
